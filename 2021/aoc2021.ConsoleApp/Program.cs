...
public sealed class Program
{
    private sealed class Options
    {
        ...
        [Option('s', "setup", HelpText = "[Number of day] Download input and description for given day, and add it to aoc2021.Puzzles along with an empty solution .cs file.")]
        public int? DayToSetup { get; private init; }

        [Usage(ApplicationAlias = "aoc2021.ConsoleApp")]
        public static IEnumerable<Example> Examples => new[]
        {
            ...
            new Example("Add input and description for day 23 to aoc2021.Puzzles along with an empty test and solution .cs file", new Options { DayToSetup = 23 }),
        };
    }
