...
REM ***
REM Publishes aoc2021.WebApp for github pages to /docs/.
REM
REM - Run tests
REM - Publish the aoc2021.WebApp project
...
set webappbase=aoc2021.WebApp
set docsbase=docs
set distbase=%webappbase%\bin\Release\netstandard2.0\publish\aoc2021.WebApp\dist
