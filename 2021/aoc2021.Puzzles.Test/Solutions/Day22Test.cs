...
public sealed class Day22Test : TestBase<Day22>
{
    ...
    [Theory]
    [MemberData(nameof(GetExampleTestcasesPart1))]
    public async Task Part2(string input, string expected, string expected2)
    {
    ...
    public async Task Part1WithInputFile()
    {
        ...
        var input = await File.ReadAllTextAsync(Path.Combine(rootDir ?? throw new InvalidOperationException("Could not find rootDir."), "Input", "Day22.txt"));

        Assert.Equal("606484", await Solution.Part1Async(input));
    }
...
on x=967..23432,y=45373..81175,z=27513..53682", "590784"
    ...
    public static IEnumerable<object[]> GetExampleTestcasesPart2() =>
    new List<object[]>
    {
            new []
            {
...
off x=-93533..-4276,y=-16170..68771,z=-104985..-24507", "2758514936282235", "474140"
            }
    };
}
