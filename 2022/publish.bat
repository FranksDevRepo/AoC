...
REM ***
REM Publishes aoc2022.WebApp for github pages to /docs/.
REM
REM - Run tests
REM - Publish the aoc2022.WebApp project
...
set webappbase=aoc2022.WebApp
set docsbase=docs
set distbase=%webappbase%\bin\Release\netstandard2.0\publish\aoc2022.WebApp\dist
