...
namespace AoC2019.Day3
{
    ...
    {
        [Theory]
        [InlineData("R75,D30,R83,U83,L2,D49,R71,U7,L72,U62, R66, U55, R34, D71, R55, D58, R83", 394)]
        [InlineData("R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51,U98, R91, D20, R16, D67, R40, U7, R15, U6, R7", 476)]
        ...
        public void TestCalculateManhattanDistanceOfIntersectionPoint(string firstMoves, string secondMoves, int expectedDistance)
        {
            Point start = new Point(0, 0);
        ...
        [Theory]
        [MemberData(nameof(TestDataGenerator.GetPointFromDataGenerator), MemberType = typeof(TestDataGenerator))]
