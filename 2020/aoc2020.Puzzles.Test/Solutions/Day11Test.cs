...
namespace aoc2020.Puzzles.Test.Solutions
{
    public sealed class Day11Test : TestBase<Day11>
    {
        ...
        {
            Assert.That(await Solution.Part1Async(myInput), Is.EqualTo("1885"));
        }
