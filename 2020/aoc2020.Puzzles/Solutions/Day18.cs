...
namespace aoc2020.Puzzles.Solutions
{
    ...
    public sealed class Day18 : SolutionBase
    {
        ...
        private char[] GetMap(string input)
        {
            ...
            myDirections = new[] { new Day10.Point(0, -1), new Day10.Point(1, 0), new Day10.Point(0, 1), new Day10.Point(-1, 0) }.Select(GetCoord).ToArray();
        ...
        private int GetCoord(Day10.Point point) => GetCoord(point.X, point.Y);

        private int GetCoord(int x, int y) => x + y * myWidth;

        private Day10.Point GetPoint(int coord) => new Day10.Point(coord % myWidth, coord / myWidth);
