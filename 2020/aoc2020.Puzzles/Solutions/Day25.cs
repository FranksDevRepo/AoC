...
namespace aoc2020.Puzzles.Solutions
{
    ...
    public sealed class Day25 : SolutionBase
    {
        ...
        private async Task FollowPath(Day11.SynchronousIntMachine intMachine, IEnumerable<string> path)
        {
        ...
        private async Task<(Dictionary<string, Room> Rooms, List<string> Items)> DiscoverRoomsAndGatherItemsAsync(Day11.SynchronousIntMachine intMachine,
        ...
        private async Task<string> RunMachineAsync(Day11.SynchronousIntMachine intMachine, string input)
        {
            var sb = new StringBuilder();
            string message = null;
            Day11.SynchronousIntMachine.ReturnCode returnCode;
            while (message == null && (returnCode = intMachine.RunUntilBlockOrComplete()) != Day11.SynchronousIntMachine.ReturnCode.Completed)
            {
