    ...
    public sealed class Day17 : SolutionBase
    {
        public override async Task<string> Part1Async(string input)
        {
            ...
            for (var y = 1; y < height - 1; y++)
            {
                ...
                {
                    if (map[new Day10.Point(x, y)] == '#' &&
                        map[new Day10.Point(x - 1, y)] == '#' &&
                        map[new Day10.Point(x + 1, y)] == '#' &&
                        map[new Day10.Point(x, y + 1)] == '#' &&
                        map[new Day10.Point(x, y - 1)] == '#')
                    {
                        alignmentSum += x * y;
                    }
        ...
        public override async Task<string> Part2Async(string input)
        {
            ...
            while (intMachine.RunUntilBlockOrComplete() != Day11.SynchronousIntMachine.ReturnCode.Completed) { }
        ...
        private async Task<List<char>> FollowPath(Dictionary<Day10.Point, char> map, Day10.Point startPos, Day10.Point startDirection)
        {
        ...
        private async Task<Dictionary<Day10.Point, char>> GetMap(Day11.SynchronousIntMachine intMachine)
        {
        ...
        private readonly Day10.Point[] Directions = new[] { new Day10.Point(0, -1), new Day10.Point(1, 0), new Day10.Point(0, 1), new Day10.Point(-1, 0) };
